...
router.register(r'directives', views.DirectiveViewSet, basename='directives')
router.register(r'tasks', views.TaskDefinitionViewSet, basename='tasks')
router.register(r'runs', views.RunViewSet, basename='runs')
router.register(r'jobs', views.JobViewSet, basename='jobs')
router.register(r'containers', views.ContainerAllowlistViewSet, basename='containers')
router.register(r'artifacts', views.RunArtifactViewSet, basename='artifacts')
